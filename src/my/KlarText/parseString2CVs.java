...
public class parseString2CVs {
    ...
    public static Boolean convertString2CV( String str, String[] keys, int CV[][], JTextArea jComment, KlarTextUI KTUI ) {
    ...
    public static Boolean convertString2Kennlinie( String str, String[] keys, int CV[][], int fs1offset, KlarTextUI KTUI ) {
        int strLen = str.length();
        int keyLen = 0;
        int dimKey = keys.length;
        int dima   = CV.length;
