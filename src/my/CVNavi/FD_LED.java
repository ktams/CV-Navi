...
public class FD_LED extends javax.swing.JFrame {
    ...
    private void jDirekteingabeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDirekteingabeActionPerformed
        ...
        if(str.equals(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("FD_LED.jDirekteingabe.text"))) {
            jCV_Inhalt.setEditable(true);
            str = java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("FD_LED.jDirekteingabe_aus.text");
            jDirekteingabe.setText(str);
        } else {
            jCV_Inhalt.setEditable(false);
            str = java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("FD_LED.jDirekteingabe.text");
            jDirekteingabe.setText(str);
        }
        jCV_Inhalt.validate();
    ...
    private void jConsistAdresseFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jConsistAdresseFocusLost
        ...
        try {
            ...
            messageBox.jLabel1.setText(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("ACHTUNG"));
            messageBox.jLabel2.setText(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("Ungueltige_Eingabe"));
            messageBox.jLabel3.setText(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("Wert_zwischen_0_127"));
        ...
        if (j > 127) {
            MsgBox messageBox = new MsgBox( (Frame) this.getParent(), true, this);
            messageBox.jLabel1.setText(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("ACHTUNG"));
            messageBox.jLabel2.setText(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("WertZuGross"));
            messageBox.jLabel3.setText(java.util.ResourceBundle.getBundle("my.CVNavi/Bundle").getString("Wert_zwischen_0_127"));
            messageBox.setVisible(true);
            j = 127;
